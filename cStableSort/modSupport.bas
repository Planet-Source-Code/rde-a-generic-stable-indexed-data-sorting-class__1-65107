...
Function strGetArraySortState(sA() As String, ByVal lbA As Long, ByVal ubA As Long, Optional ByVal Method As VbCompareMethod, Optional ByVal FastDontTestMostly As Boolean) As eSortState '-命d 2005-
...
Function strGetArraySortStateIndexed(sA() As String, idxA() As Long, ByVal lbA As Long, ByVal ubA As Long, Optional ByVal Method As VbCompareMethod, Optional ByVal FastDontTestMostly As Boolean) As eSortState '-命d 2005-
    Dim r As Long, d As Long, e As Long, cnt As Long
    Dim aeComp(n1 To n8) As eCompare
    Dim eComp As eCompare, bFlag As Boolean
    'On Error GoTo UnInit
